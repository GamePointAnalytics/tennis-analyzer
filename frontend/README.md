...
![Analyses Table Screenshot](screenshots/analyses_table.png)
...
### To learn how to use this app, please visit the [project website](https://www.tennisanalyzer.app/), where you can find a video tutorial and FAQ document.
